...
#define VENDOR_ID_IS_VALID(vendor_id)  ((vendor_id >= 0x73) && (vendor_id <= 0x87))
...
struct upgrade_module module_list[] = {
    ...
    {FTS_MODULEE_ID, FTS_MODULEE_NAME, fw_fileE, sizeof(fw_fileE)},
};
...
/* HS60 add for SR-ZQL1695-01-64 by liufurong at 20190731 start */
	fts_data->fw_in_binary = fw_ver_in_host;
...
/* HS60 add for SR-ZQL1695-01-64 by liufurong at 20190731 start */
	fts_data->fw_in_ic = fw_ver_in_tp;
/* HS60 add for SR-ZQL1695-01-64 by liufurong at 20190731 end */
...
/* HS60 modify for HS60-3614 by liufurong at 2019/10/30 start */
    fwvalid = fts_fwupg_check_fw_valid();
    if (fwvalid) {
    ...
    if((!fwvalid) || (!VENDOR_ID_IS_VALID(vendor_id))) {
...
/* HS60 modify for HS60-3614 by liufurong at 2019/10/30 end */
    if (ret < 0) {
