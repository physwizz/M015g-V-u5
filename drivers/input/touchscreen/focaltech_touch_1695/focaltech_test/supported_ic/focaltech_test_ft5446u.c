    ...
    bool is_300)
{
    ...
    if ((FACTROY_REG_SHORT_CA == mode) && (false == is_300)) {
...
static int short_compare_get_save(
...
static bool short_test_ch_to_gnd(
    struct fts_test *tdata,
    u8 *ab_ch,
    bool *result)
{
